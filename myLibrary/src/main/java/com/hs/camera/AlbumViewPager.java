...
import com.hs.camera.MatrixImageView.OnMovingListener;
import com.hs.camera.MatrixImageView.OnSingleTapListener;
...
public class AlbumViewPager extends ViewPager implements OnMovingListener {
    ...
    public AlbumViewPager(Context context, AttributeSet attrs) {
        ...
        builder = builder.showImageOnLoading(R.drawable.ic_stub)
                ...
                .cacheOnDisk(false).displayer(new MatrixBitmapDisplayer());
