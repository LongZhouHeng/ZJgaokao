...
import com.hs.DatePicker.LoopView.LoopView;
import com.hs.DatePicker.LoopView.OnItemSelectedListener;
...
public class AlertView implements OnItemSelectedListener {
    ...
    private void initData(int startyear, int endyear) {
        ...
        v_year = dateAndTime.get(Calendar.YEAR);
        v_month = dateAndTime.get(Calendar.MONTH);
        v_day = dateAndTime.get(Calendar.DAY_OF_MONTH);
