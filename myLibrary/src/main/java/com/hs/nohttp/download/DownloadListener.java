...
public interface DownloadListener {
     ...
     * @param exception error types. Error types include the following:<p>{@link com.hs.nohttp.error.ArgumentError} Need to check the download parameters are correct.</p>
     *                  <p>{@link com.hs.nohttp.error.NetworkError} The network is not available, please check the network.</p>
     *                  <p>{@link com.hs.nohttp.error.ServerError} When the response code is more than 400, you need to look at the response code specific how much is the judgement is something wrong.</p>
     *                  <p>{@link com.hs.nohttp.error.StorageReadWriteError} An error occurred when read/write memory CARDS, please check the memory card.</p>
     *                  <p>{@link com.hs.nohttp.error.StorageSpaceNotEnoughError} There is insufficient space on the memory card, please check the memory card.</p>
     *                  <p>{@link com.hs.nohttp.error.TimeoutError} Timeout connecting to the server or read the file.</p>
     *                  <p>{@link com.hs.nohttp.error.UnKnownHostError} Is not found in the network of the target server.</p>
     *                  <p>{@link com.hs.nohttp.error.URLError} Download url is wrong.</p>
     */
