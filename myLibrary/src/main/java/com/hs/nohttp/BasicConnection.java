...
import com.hs.nohttp.error.NetworkError;
import com.hs.nohttp.error.TimeoutError;
import com.hs.nohttp.error.URLError;
import com.hs.nohttp.error.UnKnownHostError;
import com.hs.nohttp.rest.HttpResponse;
import com.hs.nohttp.rest.ImplServerRequest;
...
import com.hs.nohttp.tools.NetUtil;
...
public class BasicConnection {
    ...
    protected HttpURLConnection createHttpURLConnection(BasicServerRequest request) throws IOException, URISyntaxException {
        ...
        Logger.i(TAG, "Request address: " + urlStr);
        ...
        Logger.i(TAG, "Request method: " + requestMethod.toString());
        ...
        if (requestMethod.allowRequestBody()) {
            Logger.i(TAG, "-------Send request data start-------");
            ...
            Logger.i(TAG, "-------Send request data end-------");
        }
    ...
    private void setHeaders(URI uri, HttpURLConnection connection, BasicServerRequest request) {
        ...
        for (Map.Entry<String, String> headerEntry : requestHeaders.entrySet()) {
            ...
            Logger.i(TAG, headKey + ": " + headValue);
