...
public interface OnResponseListener<T> {
     ...
     * @param exception     error types. Error types include the following:<p>{@link com.hs.nohttp.error.NetworkError} The network is not available, please check the network.</p>
     *                      <p>{@link com.hs.nohttp.error.TimeoutError} Connect to the server or a timeout occurred while reading data.</p>
